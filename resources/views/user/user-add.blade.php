...
@section('content')
    <main>
        ...
        <div class="container">
            <div class="row justify-content-center">
                @if (Auth::user()->jk == 'l')
                    <div class="col-lg-7">
                        <form action="user-pria-add" method="POST">
                            @csrf
                            <input type="hidden" id="user" value="{{ Auth::user()->nama }}" name="user">
                            <input type="hidden" id="kategori" value="Laki-laki" name="kategori">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg my-5" id="bajuPria">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Baju Pria</h3>
                                </div>
                                <div class="card shadow-lg border-0 rounded-lg my-0">
                                    <div class="card-body">
                                        
                                        <div class="card" style="max-width: 700px;">
                                                <img id="img1" name="img1" src="img/data-baju/kemeja-pria-TNI-AU-edit-400px/KEMEJA-PRIA-14.jpg" alt="" class="card-img-top" >
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="package" id="package"  class="form-control select-multiple" style="width: 129px" onchange="pilihan()">
                                                        <option value=""></option>
                                                        @foreach ($item as $i)
                                                            @if ($i->nama == 'kemeja pria')
                                                                @foreach ($i->size as $c)
                                                                    <option  data-gambarbaju="{{ $c->cover }}"  data-lebarpundak="{{$c->lebar_pundak}}" data-panjanglengan="{{$c->panjang_lengan}}" data-lingkarpinggang="{{$c->lingkar_pinggang}}" data-panjangbaju="{{$c->panjang_baju}}" data-lingkarbadan="{{$c->lingkar_badan}}" name="{{ $c->ukuran_cm }}" value="{{ $c->ukuran_cm }}">{{ $c->ukuran_cm }} cm</option>
                                                                @endforeach
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <ol>
                                                                <li><input readonly type="number" value="lebarpundak"  style="width: 50px"/> <input type="number" min="-5" max="5"  style="width: 50px" name="lebarpundakTolerant" id="lebarpundakTolerant"  value="0"/></li>
                                                                <li><input readonly type="number" value="panjanglengan" style="width: 50px"/> <input type="number" min="-5" max="5"  style="width: 50px" name="panjanglenganTolerant" id="panjanglenganTolerant"  value="0"/></li>
                                                                <li><input readonly type="number" value="lingkarpinggang" style="width: 50px"/> <input type="number" min="-5" max="5"  style="width: 50px" name="lingkarpinggangTolerant" id="lingkarpinggangTolerant"  value="0"/></li>
                                                                <li><input readonly type="number" value="panjangbaju" style="width: 50px"/> <input type="number" min="-5" max="5"  style="width: 50px" name="panjangbajuTolerant" id="panjangbajuTolerant" value="0"/></li>
                                                                <li><input readonly type="number" value="lingkarbadan" style="width: 50px"/> <input type="number" min="-5" max="5"  style="width: 50px" name="lingkarbadanTolerant" id="lingkarbadanTolerant" value="0"/></li>
                                                                <br>
                                                            </ol>
                                                        </div>
                                                    </div>                                                
                            ...
                            <div class="card shadow-lg border-0 rounded-lg my-5" id="celanaPria" hidden>
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Celana Panjang Pria</h3>
                                </div>
                                <div class="card shadow-lg border-0 rounded-lg my-0">
                                    <div class="card-body">
                                        
                                        <div class="card" style="max-width: 700px;">
                                            <img id="img2" name="img2" src="img/data-baju/Celana-Pria-TNI-AU-edit-400px/Celana-Panjang-Pria-27.jpg" alt="" class="card-img-top" >
                                            <hr>
                                            <div class="card-body">
                                            
                                                <div class="mb-3">
                                                    <label  class="form-label">Ukuran Dalam CM</label>
                                                    <select name="packageCelanaPria" id="packageCelanaPria" style="width: 129px" class="form-control select-multiple">
                                                        <option value=""></option>
                                                        @foreach ($item as $i)
                                                            @if ($i->nama == 'celana panjang pria')
                                                                @foreach ($i->size as $c)
                                                                    <option data-gambarbaju="{{ $c->cover }}" data-lebarpinggang="{{$c->lebar_pinggang}}" data-lebarpinggul="{{$c->lebar_pinggul}}" data-lebarpaha="{{$c->lebar_paha}}" data-lebarbawah="{{$c->lebar_bawah}}" data-panjangcelana="{{$c->panjang_celana}}" name="{{ $c->ukuran_cm }}" value="{{ $c->ukuran_cm }}">{{ $c->ukuran_cm }} cm</option>
                                                                @endforeach
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <ol>
                                                                ...
                                                                <li><input readonly type="number" value="lebarpinggul" style="width: 55px"/> <input type="number" min="-5" max="5"  style="width: 50px" name="lebarpinggulTolerant" id="lebarpinggulTolerant" value="0"/></li>
                            ...
                            <div class="card shadow-lg border-0 rounded-lg my-5" id="topiPria" hidden>
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Topi Pria</h3>
                                </div>
                                <div class="card shadow-lg border-0 rounded-lg my-0">
                                    <div class="card-body">
                                        ...
                                        <div class="card" style="max-width: 700px;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="packageTopiPria" id="packageTopiPria"  class="form-control select-multiple" style="width: 129px">
                                                        <option value=""></option>
                                                        @foreach ($item as $i)
                            ...
                            <div class="card shadow-lg border-0 rounded-lg my-5" id="sepatuPria" hidden>
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Sepatu Pria</h3>
                                </div>
                                <div class="card shadow-lg border-0 rounded-lg my-0">
                                    <div class="card-body">
                                        ...
                                        <div class="card" style="max-width: 700px;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    <label  class="form-label">Ukuran Dalam CM</label>
                                                    <select name="packageSepatuPria" id="packageSepatuPria"  class="form-control select-multiple" style="width: 129px">
                                                        <option value=""></option>
                                                        @foreach ($item as $i)
                                                            @if ($i->id == 4) 
                                                                @foreach ($i->size as $c)
                            ...
                            <div class="card shadow-lg border-0 rounded-lg my-5" id="hasil" hidden>
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Pria  Hasil</h3>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg my-0">
                                    <div class="card-body">
                                        ...
                                        <div class="card" style="max-width: 700px;">
                                            <div class="">
                                                <h5 class="text-center font-weight-light my-4">Baju Pria  <input class="mb-3" readonly type="text" name="hasilBajuPria" style="width: 60px"  id="hasilBajuPria"></h5>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <ol style="list-style: none">
                                                            ...
                                                            <li><input readonly type="number" value="panjanglengan" style="width: 60px"/> <input type="number" min="-5" max="5"  style="width: 50px" name="panjanglenganTolerant" id="panjanglenganTolerant"  value="0" readonly/></li>
                                                            <li><input readonly type="number" value="lingkarpinggang" style="width: 60px"/> <input type="number" min="-5" max="5"  style="width: 50px" name="lingkarpinggangTolerant" id="lingkarpinggangTolerant" value="0" readonly/></li>
                                                            ...
                                                            <li><input readonly type="number" value="lingkarbadan" style="width: 60px"/> <input type="number" min="-5" max="5"  style="width: 50px" name="lingkarbadanTolerant" id="lingkarbadanTolerant" value="0" readonly/></li>
                                                            <br>
                                                        </ol>
                                                    </div>
                                                </div>                                                
                                            ...
                                            <hr>
                                            <div class="mb-3">
                                                <h5 class="text-center font-weight-light my-4">Celana Pria  <input readonly style="width: 50px" type="text" name="hasilCelanaPria" id="hasilCelanaPria"></h5>
                                                <div class="row">
                                                    <div class="col">
                                                        <ol>
                                                            <li>Lebar Pinggang</li>
                                            ...
                                            <hr>
                                            <div class="mb-3">
                                                <h5 class="text-center font-weight-light my-4">Topi Pria   <input class="mb-3" readonly style="width: 50px" type="text"  id="hasilTopiPria"> </h5>                                            
                                            </div>
                                            <div class="mb-3">
                                                <label for="" class="form-label">Catatan</label>
                                            ...
                                            <div class="mb-3">
                                                <h5 class="text-center font-weight-light my-4">Sepatu Pria  <input class="mb-3" readonly style="width: 50px" type="text" id="hasilSepatuPria"></h5>                                              
                                            </div>
                                            <div class="mb-3">
                                                <label for="" class="form-label">Catatan</label>
    ...
    // kemeja pria
        ...
        const panjanglengan = $('#package option:selected').data('panjanglengan');
        const lingkarpinggang = $('#package option:selected').data('lingkarpinggang');
        const panjangbaju = $('#package option:selected').data('panjangbaju');
        const lingkarbadan = $('#package option:selected').data('lingkarbadan');
        const gambarbaju = $('#package option:selected').data('gambarbaju');
        
        // tampilkan data ke element
        $('[value=lebarpundak]').val(lebarpundak);
        $('[value=panjanglengan]').val(panjanglengan);
        $('[value=lingkarpinggang]').val(lingkarpinggang);
        $('[value=panjangbaju]').val(panjangbaju);
        $('[value=lingkarbadan]').val(lingkarbadan);
        $('[value=gambarbaju]').val(gambarbaju);
    ...
    $('#packageCelanaPria').on('change', function(){
        ...
        const gambarbaju = $('#packageCelanaPria option:selected').data('gambarbaju');
    ...
    $('#panjanglenganTolerant').on('change', function() {
        const panjanglenganTolerant = $("input#panjanglenganTolerant").val();
        $("input#panjanglenganTolerant").val(panjanglenganTolerant);
    });
    $('#lingkarpinggangTolerant').on('change', function() {
        const lingkarpinggangTolerant = $("input#lingkarpinggangTolerant").val();
        $("input#lingkarpinggangTolerant").val(lingkarpinggangTolerant);
    });
    ...
    $('#lingkarbadanTolerant').on('change', function() {
        const lingkarbadanTolerant = $("input#lingkarbadanTolerant").val();
        $("input#lingkarbadanTolerant").val(lingkarbadanTolerant);
    });
