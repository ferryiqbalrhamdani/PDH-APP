    ...
    <main>
        ...
        <div class="container">
            <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <form action="user-wanita-hijab-add" method="POST">
                            @csrf
                            <input type="hidden" id="user" value="{{ Auth::user()->nama }}" name="user">
                            <input type="hidden" id="kategori" value="Perempuan Hijab" name="kategori">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg my-5" id="bajuPria">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Baju Wanita Hijab</h3>
                                </div>
                                <div class="card shadow-lg border-0 rounded-lg my-0">
                                    <div class="card-body">
                                        
                                        <div class="card" style="max-width: 700px;">
                                            <img id="img1" name="img1" src="img/data-baju/KEMEJA-WANITA-HIJAB-edit-400px/KEMEJA-WANITA-HIJAB-L.jpg" class="card-img-top" alt="...">
                                            <hr>
                                            <div class="card-body">
                                            
                                                <div class="mb-3">
                                                    <label  class="form-label">Ukuran Dalam CM</label>
                                                    <select name="package" id="package"  class="form-control select-multiple" style="width: 55px; text-transform: uppercase">
                                                        <option value=""></option>
                                                        @foreach ($item as $i)
                                                            @if ($i->id == 13)
                                                                @foreach ($i->size as $c)
                                                                    <option data-gambarbaju="{{ $c->cover }}"  data-lebarpundak="{{$c->lebar_pundak}}" data-panjangTangan="{{$c->panjang_tangan}}" data-setengahlingkaran="{{$c->setengah_lingkaran}}" data-panjangbaju="{{$c->panjang_baju}}" data-lebarpunggung="{{$c->lebar_punggung}}" name="{{ $c->ukuran_cm }}" value="{{ $c->ukuran_cm }}">{{ $c->ukuran_cm }}</option>
                                                                @endforeach
                                                            @endif
                                                        @endforeach
                                                    </select>
                            ...
                            <div class="card shadow-lg border-0 rounded-lg my-5" id="celanaPria" hidden>
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Celana Panjang Wanita Hijab</h3>
                                </div>
                                <div class="card shadow-lg border-0 rounded-lg my-0">
                                    <div class="card-body">
                                        
                                        <div class="card" style="max-width: 700px;">
                                            <img id="img2" name="img2" src="img/data-baju/Celana-Panjang-Wanita-edit-400px/CELANA PANJANG WANITA HIJAB 2XS.jpg" class="card-img-top" alt="...">
                                            <hr>
                                            <div class="card-body">
                                            
                                                <div class="mb-3">
                                                    <label  class="form-label">Ukuran Dalam CM</label>
                                                    <select name="packageCelanaPria" id="packageCelanaPria" style="width: 61px; text-transform: uppercase" class="form-control select-multiple">
                                                        <option value=""></option>
                                                        @foreach ($item as $i)
                                                            @if ($i->nama == 'celana panjang wanita hijab')
                                                                @foreach ($i->size as $c)
                                                                    <option data-gambarcelana="{{ $c->cover }}" data-lebarpinggang="{{$c->lebar_pinggang}}" data-lebarpinggul="{{$c->lebar_pinggul}}" data-lebarpaha="{{$c->lebar_paha}}" data-lebarbawah="{{$c->lebar_bawah}}" data-panjangcelana="{{$c->panjang_celana}}" name="{{ $c->ukuran_cm }}" value="{{ $c->ukuran_cm }}">{{ $c->ukuran_cm }}</option>
                                                                @endforeach 
                                                            @endif
                                                        @endforeach
                                                    </select>
                            ...
                            <div class="card shadow-lg border-0 rounded-lg my-5" id="topiPria" hidden>
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Topi Wanita Hijab</h3>
                                </div>
                                <div class="card shadow-lg border-0 rounded-lg my-0">
                                    <div class="card-body">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg my-5" id="sepatuPria" hidden>
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Sepatu Wanita Hijab  </h3>
                                </div>
                                <div class="card shadow-lg border-0 rounded-lg my-0">
                                    <div class="card-body">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg my-5" id="hasil" hidden>
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Perembuan Hijab Hasil</h3>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg my-0">
                                    <div class="card-body">
                                        ...
                                        <div class="card" style="max-width: 700px;">
                                            <div class="">
                                                <h5 class="text-center font-weight-light my-4">Baju Wanita Hijab <input class="mb-3" readonly type="text" name="hasilBajuPria" style="width: 60px"  id="hasilBajuPria"></h5>
                                            ...
                                            <hr>
                                            <div class="mb-3">
                                                <h5 class="text-center font-weight-light my-4">Celana Wanita Hijab <input readonly style="width: 50px" type="text" name="hasilCelanaPria" id="hasilCelanaPria"></h5>
                                                <div class="row">
                                                    <div class="col">
                                                        <ol>
                                                            <li>Lebar Pinggang</li>
                                            ...
                                            <hr>
                                            <div class="mb-3">
                                                <h5 class="text-center font-weight-light my-4">Topi Wanita Hijab  <input class="mb-3" readonly style="width: 50px" type="text"  id="hasilTopiPria"> </h5>                                            
                                            </div>
                                            <div class="mb-3">
                                                <label for="" class="form-label">Catatan</label>
                                            ...
                                            <div class="mb-3">
                                                <h5 class="text-center font-weight-light my-4">Sepatu Wanita Hijab <input class="mb-3" readonly style="width: 50px" type="text" id="hasilSepatuPria"></h5>                                              
                                            </div>
                                            <div class="mb-3">
                                                <label for="" class="form-label">Catatan</label>
