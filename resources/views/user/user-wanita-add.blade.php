                    ...
                    <div class="col-lg-7">
                        <form action="user-wanita-add" method="POST">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg my-5" id="celanaPria" hidden>
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Rok Wanita Wanita </h3>
                                </div>
                                <div class="card shadow-lg border-0 rounded-lg my-0">
                                    <div class="card-body">
                                        
                                        <div class="card" style="max-width: 700px;">
                                            <img id="img2" name="img2" src="img/data-baju/Celana-Panjang-Wanita-edit-400px/CELANA PANJANG WANITA  2XS.jpg" class="card-img-top" alt="...">
                                            <hr>
                                            <div class="card-body">
